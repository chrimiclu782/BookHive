            ...
            if rows:
                ...
                <table border="1" style="border-collapse: collapse; width: 100%; margin: 10px 0;">
                    <tr style="background-color: #f0f0f0; height: 35px;">
                        <th style="padding: 8px; font-size: 16px; font-weight: bold; font-family: 'Avenir Next Heavy';">Borrow ID</th>
                        <th style="padding: 8px; font-size: 16px; font-weight: bold; font-family: 'Avenir Next Heavy';">Student</th>
                        <th style="padding: 8px; font-size: 16px; font-weight: bold; font-family: 'Avenir Next Heavy';">Title</th>
                        <th style="padding: 8px; font-size: 16px; font-weight: bold; font-family: 'Avenir Next Heavy';">Borrowed</th>
                        <th style="padding: 8px; font-size: 16px; font-weight: bold; font-family: 'Avenir Next Heavy';">Due</th>
                    </tr>
                """
                for row in rows:
                    table_html += f"""
