...
class AuthApp(QWidget):
    ...
    def open_register_window(self):
        """Open the role selection window for registration."""
        try:
            from role_selection import RoleSelectionWindow
        except Exception as e:
            QMessageBox.critical(self, "Import Error", f"Cannot import RoleSelectionWindow:\n{e}")
            return
        self.role_win = RoleSelectionWindow()
        self.role_win.show()
        self.close()
